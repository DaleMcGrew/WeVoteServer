...
urlpatterns = [
    ...
    # re_path(r'^attachments/(?P<template_id>[0-9a-fA-F-]+)/(?P<campaign_id>[0-9a-fA-F-]+)/(?P<draft_uuid>[0-9a-fA-F-]+)/$', views_admin.copy_attachments_to_campaign_draft,
    #         name='copy_attachments_to_campaign_draft'),
