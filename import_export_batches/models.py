...
DEDUPLICATION_SCRIPTS_CAMPAIGNX = "DEDUPLICATION_SCRIPTS_CAMPAIGNX"
DEDUPLICATION_SCRIPTS_CANDIDATE = "DEDUPLICATION_SCRIPTS_CANDIDATE"
DEDUPLICATION_SCRIPTS_CHALLENGE = "DEDUPLICATION_SCRIPTS_CHALLENGE"
DEDUPLICATION_SCRIPTS_ORGANIZATION = "DEDUPLICATION_SCRIPTS_ORGANIZATION"
DEDUPLICATION_SCRIPTS_POLITICIAN = "DEDUPLICATION_SCRIPTS_POLITICIAN"
...
MAINTENANCE_SCRIPTS_ORGANIZATION = "MAINTENANCE_SCRIPTS_ORGANIZATION"
...
MAINTENANCE_SCRIPTS_VOTER = "MAINTENANCE_SCRIPTS_VOTER"
...
KIND_OF_PROCESS_CHOICES = (
    ...
    (DEDUPLICATION_SCRIPTS_CAMPAIGNX,  'Deduplication Scripts for CampaignX'),
    (DEDUPLICATION_SCRIPTS_CANDIDATE,  'Deduplication Scripts for Candidate'),
    (DEDUPLICATION_SCRIPTS_CHALLENGE,  'Deduplication Scripts for Challenge'),
    (DEDUPLICATION_SCRIPTS_ORGANIZATION,  'Deduplication Scripts for Organization'),
    (DEDUPLICATION_SCRIPTS_POLITICIAN,  'Deduplication Scripts for Politician'),
    ...
    (MAINTENANCE_SCRIPTS_ORGANIZATION,  'Maintenance Scripts for Organization'),
    ...
    (MAINTENANCE_SCRIPTS_VOTER,  'Maintenance Scripts for Voter'),
    ...
    def create_batch_process(
        ...
        if kind_of_process not in \
                [
                    ...
                    DEDUPLICATION_SCRIPTS_CANDIDATE,
                    DEDUPLICATION_SCRIPTS_CHALLENGE,
                    DEDUPLICATION_SCRIPTS_ORGANIZATION,
                    ...
                    MAINTENANCE_SCRIPTS_ORGANIZATION,
                ...
                if batch_process.date_checked_out is None:
                    ...
                    if batch_process.kind_of_process == ACTIVITY_NOTICE_PROCESS:
                        ...
                        checked_out_expiration_time = 600  # 10 minutes * 60 seconds
                            ...
                            MAINTENANCE_SCRIPTS_ORGANIZATION,
                            MAINTENANCE_SCRIPTS_POLITICIAN]:
                        checked_out_expiration_time = 660  # 11 minutes * 60 seconds
                    elif batch_process.kind_of_process in [
                            MAINTENANCE_SCRIPTS_CAMPAIGNX,
                            MAINTENANCE_SCRIPTS_CANDIDATE,
                            MAINTENANCE_SCRIPTS_CHALLENGE,
                            ...
                            MAINTENANCE_SCRIPTS_REPRESENTATIVE,
                            MAINTENANCE_SCRIPTS_VOTER]:
                        checked_out_expiration_time = 540  # 9 minutes * 60 seconds
