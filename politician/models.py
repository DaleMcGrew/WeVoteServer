...
class Politician(models.Model):
    ...
    politician_email_subscription_secret_key = models.CharField(
        verbose_name="secret key for politician email unsubscribe", max_length=255, null=True, blank=True, unique=True)
