...
urlpatterns = [
    ...
    re_path(r'^update_is_claimed_profile_for_politicians/',
            views_data_cleaning.update_is_claimed_profile_for_politicians,
            name='update_is_claimed_profile_for_politicians'),
